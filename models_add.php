    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-primary">
          <h5 class="modal-title" id="addBrokerModalLabel">New Brand</h5>
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="form-group">
                <label for="brokerGramPanchayat" class="mb-2">Brand</label>
                <select class="form-control" id="brokerGramPanchayat" required>
                  <option>HERO</option>
                </select>
              </div>
            <div class="form-group mt-4">
                <label for="brokerName" class="mb-2">Modal</label>
                <input type="text" class="form-control" id="brokerName" placeholder="Enter Modal" required>
              </div>
              ...
              <table class="table table-bordered table-hover">
                <thead class="thead-light ">
                  <tr >
                    ...
                    <th class="bg-warning">Brand/Type</th>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form>
                      <div class="form-group ">
                        <label for="brokerName" class="mb-2">Brand</label>
                        <input type="text" class="form-control" id="brokerName" placeholder="Enter  Brand" required>
                      </div>
                      <div class="form-group mt-4">
                        <label for="brokerName" class="mb-2">Model</label>
                        <input type="text" class="form-control" id="brokerName" placeholder="Enter  Model" required>
                      </div>
                      <div class="form-group mt-4">
                        <label for="brokerGramPanchayat" class="mb-2">Status</label>
                        <select class="form-control" id="brokerGramPanchayat" required>
